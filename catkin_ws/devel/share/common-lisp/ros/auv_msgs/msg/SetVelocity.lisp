...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auv_msgs-msg:<SetVelocity> is deprecated: use auv_msgs-msg:SetVelocity instead.")))

(cl:ensure-generic-function 'surgeSpeed-val :lambda-list '(m))
(cl:defmethod surgeSpeed-val ((m <SetVelocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs-msg:surgeSpeed-val is deprecated.  Use auv_msgs-msg:surgeSpeed instead.")
  (surgeSpeed m))

(cl:ensure-generic-function 'swaySpeed-val :lambda-list '(m))
(cl:defmethod swaySpeed-val ((m <SetVelocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_msgs-msg:swaySpeed-val is deprecated.  Use auv_msgs-msg:swaySpeed instead.")
  (swaySpeed m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <SetVelocity>))
...
(cl:defmethod roll-val ((m <SetVelocity>))
...
(cl:defmethod pitch-val ((m <SetVelocity>))
...
(cl:defmethod yaw-val ((m <SetVelocity>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SetVelocity>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'surgeSpeed))))
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'swaySpeed))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SetVelocity>) istream)
  "Deserializes a message object of type '<SetVelocity>"
    ...
    (cl:setf (cl:slot-value msg 'surgeSpeed) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'swaySpeed) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetVelocity>)))
  ...
  (cl:format cl:nil "float64 surgeSpeed~%float64 swaySpeed~%float64 depth~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetVelocity)))
  "Returns full string definition for message of type 'SetVelocity"
  (cl:format cl:nil "float64 surgeSpeed~%float64 swaySpeed~%float64 depth~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SetVelocity>))
  ...
  (cl:list 'SetVelocity
    (cl:cons ':surgeSpeed (surgeSpeed msg))
    (cl:cons ':swaySpeed (swaySpeed msg))
