...
if("TRUE" STREQUAL "TRUE")
  set(simulator_SOURCE_PREFIX /home/vivi/auv/catkin_ws/src/simulator)
  set(simulator_DEVEL_PREFIX /home/vivi/auv/catkin_ws/devel)
  ...
  set(simulator_INSTALL_PREFIX /home/vivi/auv/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dbhage <neerav789@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vivi/auv/catkin_ws/src/simulator/${idir}'.  Ask the maintainer 'dbhage <neerav789@gmail.com>' to fix it.")
    endif()
