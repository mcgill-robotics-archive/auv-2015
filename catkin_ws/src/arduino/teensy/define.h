...
#define SOLENOID_PIN_STARBOARD_DROPPER      24
#define SOLENOID_PIN_PORT_GRABBER           25
#define SOLENOID_PIN_STARBOARD_GRABBER      26
#define SOLENOID_PIN_PORT_TORPEDO           27
#define SOLENOID_PIN_STARBOARD_TORPEDO      28
